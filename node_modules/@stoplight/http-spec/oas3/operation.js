...
exports.transformOas3Operation = ({ document, path, method }) => {
    ...
    const operation = utils_1.maybeResolveLocalRef(document, pathObj[method]);
    if (!operation) {
    ...
    const httpOperation = {
        ...
        request: request_1.translateToRequest(document, accessors_1.getValidOasParameters(document, operation.parameters, pathObj.parameters), operation.requestBody),
        ...
        extensions: accessors_1.getExtensions(operation),
    };
