...
function translateToResponse(document, produces, response, statusCode) {
    ...
    if (!guards_1.isResponseObject(resolvedResponse))
        return;
    const headers = params_1.translateToHeaderParams(document, resolvedResponse.headers || {});
    ...
    const contents = produces
        ...
        schema: utils_1.isDictionary(resolvedResponse.schema) ? schema_1.translateSchemaObject(document, resolvedResponse.schema) : void 0,
