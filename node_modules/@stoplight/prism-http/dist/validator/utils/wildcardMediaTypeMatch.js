...
function wildcardMediaTypeMatch(mediaTypeA, mediaTypeB) {
    return function_1.pipe(O.Do, O.bind('a', () => parseContentType(mediaTypeA)), O.bind('b', () => parseContentType(mediaTypeB)), O.fold(() => false, ({ a, b }) => {
...
function parseContentType(contentType) {
    return function_1.pipe(O.tryCatch(() => content_type_1.parse(contentType)), O.chain(({ type }) => {
