...
const forward = ({ data: input, validations }, baseUrl, upstreamProxy, resource) => logger => function_1.pipe(NEA.fromArray(validations), TE.fromOption(() => undefined), TE.map(failedValidations => {
