...
function generateParamValues(specs) {
    return function_1.pipe(specs, E.traverseArray(spec => function_1.pipe(generateParamValue(spec), E.map(value => [encodeURI(spec.name), value]))), E.map(lodash_1.fromPairs));
}
